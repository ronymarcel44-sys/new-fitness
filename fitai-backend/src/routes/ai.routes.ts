...
- body_recomposition: mainTargetBodyFatPct (كتلة العضلة والوزن النهائي كلاهما يُحسبان تلقائياً بالسيرفر من هذا الرقم — لا تحاول حسابهما أو وضعهما بنفسك)
...
- fat_loss → **رقمان معاً**: (1) نسبة دهون نهائية "رياضية" واقعية — تقريباً 12-15% للرجال، 20-23% للنساء كخيار آمن، و(2) الوزن النهائي المقابل لتلك النسبة تقريباً بناءً على طوله ووزنه الحالي. اذكر الرقمين معاً في نفس الجملة (مثال: "هدف واقعي هو الوصول لحوالي 75 كغ بنسبة دهون تقريبية 14%").
...
- body_recomposition → **نسبة دهون نهائية فقط** (نفس نطاق fat_loss أعلاه) — رقم واحد فقط هنا، مع ذكر أن الوزن وكتلة العضل بيتغيرون تلقائياً معها (لا تقترح رقم وزن أو كتلة عضل منفصل لهذا الهدف).
